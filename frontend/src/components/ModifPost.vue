    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" v-if="editOption=='modify'">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="updatePost">Enregistrer les changements</button>
        </div>
      </div>
      ...
      <div class="modal-content" v-else>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
          <button type="button" class="btn btn-danger" @click="deletePost">Supprimer le message</button>
        </div>
      </div>
    </div>
  </div>
