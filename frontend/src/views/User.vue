  ...
  <main class="main">
    ...
    <section class="row user-info pl-5 pr-5">
      <div class="col-12">
        ...
        <div class="user-info__block">
          <p class="user-info__block__title mb-0">Nom d'utilisateur</p>
          <p class="user-info__block__output">
        ...
        <div class="user-info__block d-sm-flex justify-content-between user-info__block--flex">
          <div class="user-info__block">
            <p class="user-info__block__title mb-0">Mot de passe</p>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="BoxModalChgPwd__title">Changer le mot de passe</h5>
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" @click="changePassword">enregistrer les modification</button>
                </div>
